...
<table class="all">
    ...
    <tr class="tt">
        <td><?= $big['name'] ?></td>
        <td class="ct">
            <button class="edit_btn" data-id="<?= $big['id'] ?>">修改</button>
            <button class="del_btn" data-id="<?= $big['id'] ?>">刪除</button>
        </td>
    </tr>
    <?php
    ...
    <tr class=" pp tt">
        <td><?= $mid['name'] ?></td>
        <td class="ct">
            <button class="edit_btn" data-id="<?= $mid['id'] ?>">修改</button>
            <button class="del_btn" data-id="<?= $mid['id'] ?>">刪除</button>
        </td>
    </tr>
    <?php
              endforeach;
