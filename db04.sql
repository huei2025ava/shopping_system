...
(7, 'admin', '1234', 'a:5:{i:0;s:1:\"1\";i:1;s:1:\"2\";i:2;s:1:\"3\";i:3;s:1:\"4\";i:4;s:1:\"5\";}'),
(8, 'root', '1234', 'a:2:{i:0;s:1:\"1\";i:1;s:1:\"3\";}'),
(9, 'apple', '1234', 'a:3:{i:0;s:1:\"1\";i:1;s:1:\"2\";i:2;s:1:\"4\";}');
...
(2, 'mem01', '1234', 'amy', '0988123456', '456', '456@gmail.com', '2026-02-03'),
(3, 'aaa', '1234', 'aaa', 'aaa', 'ccc', 'vvvv', '2026-02-03');
...
(1, '20260223975904', 'aaa', 'aaa', 'aaa', 'ccc', 'vvvv', 143885, 'a:3:{i:2;s:1:\"1\";i:3;s:1:\"4\";i:6;s:1:\"5\";}', '2026-02-23');
...
CREATE TABLE `types` (
  ...
  `name` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '分類名稱',
  `big_id` int(11) NOT NULL DEFAULT 0 COMMENT '所屬大分類ID (0表示大分類)'
