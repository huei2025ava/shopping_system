...
<div id="newsTitle">
    ...
    <table class="all">
        ...
        <tr class="pp">
            <td style='cursor:pointer' onclick="$('#newsTitle').hide();$('#news1').show();$('#news2').hide()">情人節特惠活動
            </td>
        </tr>
        <tr class="pp">
            <td style='cursor:pointer' onclick="$('#newsTitle').hide();$('#news1').hide();$('#news2').show()">年終特賣會開跑了
            </td>
        </tr>
    </table>
</div>
